...
class BrookingsCrawler:
    def __init__(self):
        self.start_url = 'https://www.brookings.edu/research/robotic-rulemaking/'
        self.max_pages = 10
    ...
    def is_brookings_url(self):
        self.parsed_url = urlparse(self.current_url)
        return self.parsed_url.netloc == "www.brookings.edu"
    ...
    def extract_links(self):
        ...
        for self.a_tag in self.soup.find_all('a', href=True):
            ...
            if self.is_brookings_url() and self.full_url not in self.visited_pages:
